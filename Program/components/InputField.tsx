...
export const InputField = ({label, placeholder, callback}: {label: string, placeholder:string, callback: any}) => {
    return(
        <View style={{flexDirection:"column", paddingVertical: 10}}>
            ...
            <TextInput style={{height: 30, borderWidth: 1, borderColor: "#D3D3D3", borderRadius: 5, width: Dimensions.get("window").width/20*15}} placeholder={placeholder} onChangeText={callback}/>
        </View>
    )
}
